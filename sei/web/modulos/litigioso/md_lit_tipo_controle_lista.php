        ...
        for ($i = 0; $i < $numRegistros; $i++) {
            ...
            if ($_GET['acao'] != 'md_lit_tipo_controle_selecionar') {
                ...
                if (empty($arrObjTipoControleLitigiosoDTO[$i]->getStrSinParamModalComplInteressado())) {
                    $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_parametrizar_interessado_cadastrar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_processo_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="modulos/litigioso/imagens/svg/cog_vazia.svg?11" title="Parametrizar Dados Complementares - ' . $siglaTipoControle . '" alt="Parametrizar Dados Complementares - ' . $siglaTipoControle . '" class="infraImgGrid" /></a>&nbsp;';
                } else {
                    $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_parametrizar_interessado_cadastrar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_processo_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="modulos/litigioso/imagens/svg/icone_parametrizar.svg?11" title="Parametrizar Dados Complementares - ' . $siglaTipoControle . '" alt="Parametrizar Dados Complementares - ' . $siglaTipoControle . '" class="infraImgGrid" /></a>&nbsp;';
                }

                $strResultado .= '<a href="' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_tipo_controle_tipo_decisao_consultar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_controle_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso()) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="modulos/litigioso/imagens/png/associar.png?11" title="Associar Tipos de Decisão - ' . $siglaTipoControle . '" alt="Associar Tipos de Decisão - ' . $siglaTipoControle . '" class="infraImgGrid" /></a>&nbsp;';

                $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_associar_dispositivo_normativo_consultar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_controle_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="modulos/litigioso/imagens/png/livro.png?11" title="Dispositivos Normativos Associados - ' . $siglaTipoControle . '" alt="Dispositivos Normativos Associados - ' . $siglaTipoControle . '" class="infraImgGrid" /></a>&nbsp;';

                //link para a tela de parametrizar situacoes
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_situacao_parametrizar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_processo_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/menu.svg?11" title="Parametrizar Situações - ' . $siglaTipoControle . '" alt="Parametrizar Situações - ' . $siglaTipoControle . '" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoConsultar) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_tipo_controle_consultar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_processo_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/consultar.svg?11" title="Consultar Tipo de Controle Litigioso" alt="Consultar Tipo de Controle Litigioso" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoAlterar && $isAdministradorSEI) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_tipo_controle_alterar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_processo_litigioso=' . $arrObjTipoControleLitigiosoDTO[$i]->getNumIdTipoControleLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/alterar.svg?11" title="Alterar Tipo de Controle Litigioso" alt="Alterar Tipo de Controle Litigioso" class="infraImg" /></a>&nbsp;';
            }
            ...
            if ($bolAcaoDesativar && $arrObjTipoControleLitigiosoDTO[$i]->getStrSinAtivo() == 'S' && $isAdministradorSEI) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->montarAncora($strId) . '" onclick="acaoDesativar(\'' . $strId . '\',\'' . $strDescricao . '\');" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/desativar.svg" title="Desativar Tipo de Controle Litigioso" alt="Desativar Tipo de Controle Litigioso" class="infraImg" /></a>&nbsp;';
            } else if ($isAdministradorSEI && $bolAcaoReativar) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->montarAncora($strId) . '" onclick="acaoReativar(\'' . $strId . '\',\'' . $strDescricao . '\');" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/reativar.svg" title="Reativar Tipo de Controle Litigioso" alt="Reativar Tipo de Controle Litigioso" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoExcluir && $isAdministradorSEI) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->montarAncora($strId) . '" onclick="acaoExcluir(\'' . $strId . '\',\'' . $strDescricao . '\');" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/excluir.svg" title="Excluir Tipo de Controle Litigioso" alt="Excluir Tipo de Controle Litigioso" class="infraImg" /></a>&nbsp;';
            }
