    ...
    function adicionarInteressado(contato) {
        ...
        if (dadoCompleto) {
            acaoDadosComplementares = "<img onclick=\"abrirModalDadosInteressado('" + contato.urlDadosComplementares + "')\" " +
                " style='width: 24px' title='Dados Complementares do Interessado' src='modulos/litigioso/imagens/png/dadoComplementar.png' class='infraImg'/>&nbsp;<input type='hidden' id='hdnContatoPossuiDadoComplementa_" + contato.idContato + "' value='" + contato.contatoPossuiDadoComplementar + "'>";
        }
