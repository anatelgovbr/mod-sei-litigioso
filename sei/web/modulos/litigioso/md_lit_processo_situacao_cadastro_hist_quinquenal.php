...
//Tabela de resultado.
if ($numRegistros > 0) {
    $strResultado .= '<table width="99%" class="infraTable" summary="Histórico de Datas de Prescrição Quinquenal">';
    $strResultado .= '<caption class="infraCaption">';
    $strResultado .= PaginaSEI::getInstance()->gerarCaptionTabela('Histórico de Datas de Prescrição Quinquenal', $numRegistros);
    ...
    $strResultado .= PaginaSEI::getInstance()->getThOrdenacao($objMdLitProcessoSituacaoDTO, 'Prescrição Quinquenal', 'Quinquenal', $arrObjs);
    $strResultado .= '</th>';
    ...
    for ($i = 0; $i < $numRegistros; $i++) {
        ...
        $strResultado .= '<td>';
        $strResultado .= PaginaSEI::tratarHTML($arrObjs[$i]->getDtaQuinquenal());
        $strResultado .= '</td>';
