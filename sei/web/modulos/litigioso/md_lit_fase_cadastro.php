...
<form id="frmFaseCadastro" method="post" onsubmit="return OnSubmitForm();"
    ...
    ?>
    <label id="lblNome" for="txtNome" accesskey="f" class="infraLabelObrigatorio">Nome da Fase:</label>
  ...
  <textarea type="text" id="txtDescricao" rows="3" name="txtDescricao" class="infraText"
