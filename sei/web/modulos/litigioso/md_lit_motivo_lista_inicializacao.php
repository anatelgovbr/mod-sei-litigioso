...
if ($numRegistros > 0){
    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
        ...
        if ($bolAcaoConsultar){
            $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_motivo_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_md_lit_motivo='.$arrObjMdLitMotivoDTO[$i]->getNumIdMdLitMotivo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioSvgGlobal().'/consultar.svg" title="Consultar motivo" alt="Consultar motivo" class="infraImg" /></a>&nbsp;';
        }

        if ($bolAcaoAlterar){
            $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_motivo_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_md_lit_motivo='.$arrObjMdLitMotivoDTO[$i]->getNumIdMdLitMotivo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioSvgGlobal().'/alterar.svg" title="Alterar motivo" alt="Alterar motivo" class="infraImg" /></a>&nbsp;';
        }
        ...
        if ($bolAcaoDesativar && $arrObjMdLitMotivoDTO[$i]->getStrSinAtivo()=='S'){
            ...
            $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioSvgGlobal().'/desativar.svg" title="Desativar motivo" alt="Desativar motivo" class="infraImg" /></a>&nbsp;';
        }else if($bolAcaoReativar && $arrObjMdLitMotivoDTO[$i]->getStrSinAtivo()=='N'){
            $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioSvgGlobal().'/reativar.svg" title="Reativar motivo" alt="Reativar motivo" class="infraImg" /></a>&nbsp;';
        ...
        if ($bolAcaoExcluir){
            $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioSvgGlobal().'/excluir.svg" title="Excluir motivo" alt="Excluir motivo" class="infraImg" /></a>&nbsp;';
        }
