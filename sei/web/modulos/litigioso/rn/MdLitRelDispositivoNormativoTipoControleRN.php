<?
    ...
    class MdLitRelDispositivoNormativoTipoControleRN extends InfraRN
    {
        ...
        protected function excluirControlado($arrObjMdLitRelDispositivoNormativoTipoControleDTO){
            try {
                ...
                for($i=0;$i<count($arrObjMdLitRelDispositivoNormativoTipoControleDTO);$i++){
                    $objMdLitRelDispositivoNormativoTipoControleBD->excluir($arrObjMdLitRelDispositivoNormativoTipoControleDTO[$i]);
                }

                //Auditoria

            }catch(Exception $e){
                throw new InfraException('Erro excluindo dispositivo do tipo de controle.',$e);
            }
        }
