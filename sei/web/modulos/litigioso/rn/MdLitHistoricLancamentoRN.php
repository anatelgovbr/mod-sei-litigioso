...
class MdLitHistoricLancamentoRN extends InfraRN {
  ...
  private function validarNumIdUsuario(MdLitHistoricLancamentoDTO $objMdLitHistoricLancamentoDTO, InfraException $objInfraException){
    if (InfraString::isBolVazia($objMdLitHistoricLancamentoDTO->getNumIdUsuario())){
      $objInfraException->adicionarValidacao('usuario não informado.');
    }
  }

  private function validarNumIdUnidade(MdLitHistoricLancamentoDTO $objMdLitHistoricLancamentoDTO, InfraException $objInfraException){
    if (InfraString::isBolVazia($objMdLitHistoricLancamentoDTO->getNumIdUnidade())){
...
//      SessaoSEI::getInstance()->validarPermissao('md_lit_historic_lancamento_cadastrar');
      ...
      $this->validarNumIdUnidade($objMdLitHistoricLancamentoDTO, $objInfraException);
  ...
  protected function alterarControlado(MdLitHistoricLancamentoDTO $objMdLitHistoricLancamentoDTO){
    try {
      ...
      if ($objMdLitHistoricLancamentoDTO->isSetNumIdUsuario()){
        $this->validarNumIdUsuario($objMdLitHistoricLancamentoDTO, $objInfraException);
      }
      if ($objMdLitHistoricLancamentoDTO->isSetNumIdUnidade()){
        $this->validarNumIdUnidade($objMdLitHistoricLancamentoDTO, $objInfraException);
      }
