...
try {
    ...
    if ($numRegistros > 0) {
        ...
        for ($i = 0; $i < $numRegistros; $i++) {
            ...
            if ($bolAcaoConsultar) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_tipo_decisao_consultar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_decisao_litigioso=' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/consultar.svg" title="Consultar Tipo de Decisão" alt="Consultar Tipo de Decisão" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoAlterar) {
                $strResultado .= '<a href="' . PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_tipo_decisao_alterar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . $_GET['acao'] . '&id_tipo_decisao_litigioso=' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso())) . '" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/alterar.svg" title="Alterar Tipo de Decisão" alt="Alterar Tipo de Decisão" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoDesativar && $arrObjTipoDecisaoLitigiosoDTO[$i]->getStrSinAtivo() == 'S') {
                $strResultado .= '<a href="#ID-' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso() . '"  onclick="acaoDesativar(\'' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso() . '\',\'' . PaginaSEI::tratarHTML($arrObjTipoDecisaoLitigiosoDTO[$i]->getStrNome()) . '\');" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/desativar.svg" title="Desativar Tipo de Decisão" alt="Desativar Tipo de Decisão" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoReativar && $arrObjTipoDecisaoLitigiosoDTO[$i]->getStrSinAtivo() == 'N') {
                $strResultado .= '<a href="#ID-' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso() . '"  onclick="acaoReativar(\'' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso() . '\',\'' . PaginaSEI::tratarHTML($arrObjTipoDecisaoLitigiosoDTO[$i]->getStrNome()) . '\');" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/reativar.svg" title="Reativar Tipo de Decisão" alt="Reativar Tipo de Decisão" class="infraImg" /></a>&nbsp;';
            }

            if ($bolAcaoExcluir) {
                $strResultado .= '<a href="#ID-' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso() . '"  onclick="acaoExcluir(\'' . $arrObjTipoDecisaoLitigiosoDTO[$i]->getNumIdTipoDecisaoLitigioso() . '\',\'' . PaginaSEI::tratarHTML($arrObjTipoDecisaoLitigiosoDTO[$i]->getStrNome()) . '\');" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '"><img src="' . PaginaSEI::getInstance()->getDiretorioSvgGlobal() . '/excluir.svg" title="Excluir Tipo de Decisão" alt="Excluir Tipo de Decisão" class="infraImg" /></a>&nbsp;';
            }
