<script type="text/javascript">
    ...
    var bolConsultaDadosComplementaresSemResultado = false;
    ...
    function inicializar(){
        ...
        objTblDadosComplementares.remover = function (arrLinha){
            ...
            // apos remover, ocultar a tabela se nao restar item
            setTimeout(function(){
    ...
    function adicionarDadosComplementares(){
        if(document.getElementById('optOutorgadaSim').checked){
            ...
            if(document.querySelector('.fldInfoComplementares') != null && objTblDadosComplementaresConsulta.tbl.rows.length <= 1){
            ...
            document.getElementById('txtNumero').value = '';
            bolConsultaDadosComplementaresSemResultado = false;
        }
    }
...
//                        nomeCidade      = nomeCidade;
    ...
    function verificarPaiFieldSet(element){
        ...
        while (element.parentNode){
            if(element.parentNode.classList && element.parentNode.classList.contains('fldInfoComplementares')){
                return true;
            }else{
...
//            dataType: "xml",
    ...
    function desabilitarCampos(element){
        if(element.value == ''){
            infraHabilitarCamposDiv(document.querySelector('.fldInfoComplementares'));
        }else{
            infraDesabilitarCamposDiv(document.querySelector('.fldInfoComplementares'));
