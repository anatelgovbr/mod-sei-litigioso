...
?>
    <form id="frmCadastroProcesso" method="post" onsubmit="return OnSubmitForm();"
        ...
        <div class="linha">
            ...
            <fieldset class="infraFieldset form-control fieldsetDocInstaurador"
        ...
        <div class="linha">
            ...
            <div class="rowFieldSet">
                ...
                <fieldset class="infraFieldset NumeroSEINaoValidado form-control fieldsetDocInstaurador">
        ...
        <div>
            ...
            if ($bolTipoProcedimentosSobrestadosGeracao > 0) {
                echo '<fieldset class="infraFieldset NumeroSEINaoValidado form-control fieldsetProcessos">';
            } else {
                echo '<fieldset class="infraFieldset form-contrl fieldsetProcessos" style="display:none!important">';
            }
            ?>
            ...
            <div style=" float: left; width: 100%;">
                ...
                <div style=" float: left; width: 25%;">
                    <button type="button" name="sbmAdicionarNumeroSeiPS" onclick="adicionarPS();"
                            id="sbmAdicionarNumeroSeiPS" value="Adicionar" class="infraButton"
                            tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">Adicionar
                    </button>
                </div>
            </div>
    ...
    <form target="alterarContato" method="post" id="frmAlterarContato">
        ...
        <input type="hidden" id="hdnMotivosContato" name="hdnMotivos" value="<?= $_POST['hdnMotivos'] ?>"/>
    </form>
<?
