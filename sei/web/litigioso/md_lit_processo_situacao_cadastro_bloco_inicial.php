<div class="row linha">
    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <label class="infraLabelObrigatorio" name="lblTipoCtrlTitulo">Tipo de Controle
            Litigioso:</label>
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 text-right">
        <?php if ($diferencaEntreDias): ?>
            <div class="grid grid_5" style="margin-right: 5px;float: right; width: 350px; margin-top: 9px">
                <label class="infraLabelOpcional" name="lblTipoCtrlDetalhe"
...
<input type="hidden" name="hdnPrazoDiasSugVenc" id="hdnPrazoDiasSugVenc" value="<?php echo $numPrazoDiasSugVenc; ?>"/>
<input type="hidden" name="hdnPrazoDiasCritVencMin" id="hdnPrazoDiasCritVencMin" value="<?php echo $numPrazoDiasCritVencMin; ?>"/>
