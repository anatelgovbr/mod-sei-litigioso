...
try {
    ...
    switch ($_GET['acao']) {
        ...
        case 'md_lit_situacao_lancamento_consultar':
            ...
            $arrComandos[] = '<button type="button" accesskey="C" id="' . 'btn' . 'Cancelar' . '" onclick="cancelar()" class="infraButton">
    ...
    <form id="frmSituacaoCadastro" method="post" action="<?= $strAcaoForm ?>">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="form-group">
                                <label for="rdoIntegracao" name="lblIntegracao" class="radio-label infraLabelRadio">
                                    ...
                                    <a <?= PaginaSEI::montarTitleTooltip($strToolTipLblInt, 'Ajuda') ?>
                                ...
                                <label for="rdoManual" name="lblManual" class="radio-label infraLabelRadio">
                                    ...
                                    Manual
                                    <a <?= PaginaSEI::montarTitleTooltip($strToolTipLblMan, 'Ajuda') ?>
                                        tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                        <img border="0"
                                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg?<?= Icone::VERSAO ?>"
                                                class="infraImgModulo"/>
        ...
        <div class="" id="divIntegracao"
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-5 col-xl-4">
                    <div class="form-group">
                        <label for="tipoWs" class="infraLabelObrigatorio">
                            Tipo Cliente WS:
                        </label>
                        <br/>
            ...
            <div class="row" id="gridOperacao">
                <div class="col-sm-12 col-md-12 col-lg-10 col-xl-9">
                    <label class="infraLabelObrigatorio" id="lbloperacao" for="txtOperacao">Operação:
                        <a <?= PaginaSEI::montarTitleTooltip($strToolTipEnd, 'Ajuda') ?>
                            tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                            <img border="0"
                                    src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg?<?= Icone::VERSAO ?>"
                                    class="infraImgModulo"/>
        ...
        <div class="" id="divManual"
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-10 col-xl-9">
                    <div class="form-group">
                        <label class="infraLabelObrigatorio" for="txtDescricao">Descrição:</label>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-10 col-xl-9">
                    <div class="form-group">
                        <label class="infraLabelObrigatorio" for="txtDescricao">Cor para
                            Apresentação
                            da Situação:</label>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-10 col-xl-9">
                    <div class="form-group">
                        <label class="infraLabelObrigatorio" for="txtDescricao">Situação de
                            Cancelamento?</label>
