<?
  ...
  switch($_GET['acao']){
      ...
      $objTipoControleLitigiosoDTO->setNumPrazoDiasSugVenc($_POST['txtPrazoDiasSugVenc']);
      $objTipoControleLitigiosoDTO->setNumPrazoDiasCritVencMin($_POST['txtPrazoDiasCritVencMin']);
