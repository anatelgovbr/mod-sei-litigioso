...
class MdLitRelDecisLancamentDTO extends InfraDTO {
  ...
  public function montar() {
   ...
   $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_DBL, 'Multa', 'multa', 'md_lit_decisao');

   $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_DBL, 'IdMdLitDecisaoOrigem', 'id_md_lit_decisao_origem', 'md_lit_decisao');
