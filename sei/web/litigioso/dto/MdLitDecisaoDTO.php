...
class MdLitDecisaoDTO extends InfraDTO
{
    ...
    public function montar()
    {
        ...
        $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdMdLitDecisaoOrigem', 'id_md_lit_decisao_origem');
        ...
        $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'DescricaoDispNorm', 'disp.descricao', 'md_lit_disp_normat disp');
