...
class MdLitHistoricLancamentoRN extends InfraRN {
  ...
  private function validarStrSequencial(MdLitHistoricLancamentoDTO $objMdLitHistoricLancamentoDTO, InfraException $objInfraException){
    if ($objMdLitHistoricLancamentoDTO->isSetStrSequencial() && $objMdLitHistoricLancamentoDTO->getStrSequencial()){
  ...
  private function validarStrLinkBoleto(MdLitHistoricLancamentoDTO $objMdLitHistoricLancamentoDTO, InfraException $objInfraException){
    if ($objMdLitHistoricLancamentoDTO->isSetStrLinkBoleto() && $objMdLitHistoricLancamentoDTO->getStrLinkBoleto()){
  ...
  protected function prepararCadastrarControlado(MdLitHistoricLancamentoDTO $objMdLitHistoricLancamentoDTO){
      ...
      $objMdLitLancamentoDTOAntigo = $this->consultar($objMdLitLancamentoDTOAntigo);
        if($objMdLitLancamentoDTOAntigo === null || (
            ...
            || (
                $objMdLitHistoricLancamentoDTO->isSetDblVlrDesconto()
                && $objMdLitHistoricLancamentoDTO->isSetDtaUltimoPagamento()
                && $objMdLitHistoricLancamentoDTO->isSetDblVlrPago()
                && $objMdLitHistoricLancamentoDTO->isSetDblVlrLancamento()
                && (
            ...
            $objMdLitLancamentoDTOAntigo->setStrSequencial($objMdLitHistoricLancamentoDTO->getStrSequencial());
  ...
  public function incluirHistoricoCancelaLancamento($objMdLitLancamentoDTO)
  {
  ...
  public function copiarObjLancamentoObjHistorico($objMdLitLancamentoDTO){
    ...
    if($objMdLitLancamentoDTO->isSetStrCodigoReceita()) {
