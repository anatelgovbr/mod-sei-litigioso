        ...
        <fieldset class="infraFieldset form-control" id="fieldsetMulta"
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-right">
                    ...
                    <!-- Incluir e/ou Retificar -->
                    <button id="btnSalvarLancamentos" name="btnSalvarLancamentos" type="button"
                            onclick="salvarLancamentosDireto(this)"
                            data-url="<?= SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_lit_multa_justificativa&id_procedimento=' . $idProcedimento . '&id_md_lit_funcionalidade=' . MdLitIntegracaoRN::$ARRECADACAO_RETIFICAR_LANCAMENTO); ?>"
                            value="Incluir e/ou Retificar"
                            style="display: none;" class="infraButton btnLancamento">Incluir e/ou Retificar
                    </button>
            ...
            <div id="detalhesLancamento">  
                <div class="row" id="divCreditoProcesso" style="<?= $strComboCreditoProcesso == '' ? 'display:none' : '' ?>">
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3" style="margin-top: 26px;">
                        <img id="btnFracionarMultas"
                            src="modulos/litigioso/imagens/svg/fracionar_multas.svg?<?= Icone::VERSAO ?>"
                            alt="Fracionar multas" title="Fracionar Multas" class="infraImg"
                            style="width: 25px; height: 25px; cursor: pointer;"
                            data-url="<?= $strLinkModalFracionarMultas ?>"
                            onclick="abrirModalFracionarMultas()" />
                    </div>
                </div>
            ...
            <div id="msgRetificacaoDupla" class="col-sm-12 col-md-8 col-lg-8 col-xl-8" style="background: #f2f2f2; border: 1px solid #ddd; padding: 10px 12px; border-radius: 6px; font-weight: bold; font-size: 14px;display:none">
                Foram alterados informações de Lançamentos diferentes.<br><br>
                Ao salvar serão afetados tanto o Lançamento inicial quanto o Lançamento fracionado.
            </div>
            <br>
            <div class="row linha">
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div id="divDataGestaoMulta">
                        ...
                        <div class="row" id="divDtaDecursoPrazoRecursoManual" style="display: none">
                            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                                <div class="form-group">
                                    <label class="infraLabelOpcional"
                                        name="lblDtDecursoPrazoRecurso"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                                <div class="form-group">
                                    ...
                                    <a style="margin-left: 5px;; margin-top: 6px;"
                                       id="btAjudaDtVencimento" <?= PaginaSEI::montarTitleTooltip('A Data de Vencimento para o pagamento da Multa deve ser informada neste campo. \n \n O sistema faz uma sugestão automática a partir do que foi sugerido para o campo de Data da Decisão de Aplicação da Multa acrescido da quantidade de dias parametrizada no Tipo de Controle Litigioso, mas que deve ser conferida e ajustada se for o caso.', 'Ajuda') ?>
                                       tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                        ...
                        <div class="row" id="apresentacao-recurso" style="<?= $dtaApresentacaoRecurso ? '' : 'display: none' ?> ">
                            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                                <div class="form-group">
                                    ...
                                    <a style="margin-left: 5px;; margin-top: 6px;"
                                       <?= PaginaSEI::montarTitleTooltip('A Data de Apresentação do Recurso é a data do protocolo do Documento no Órgão e exigirá a Retificação de Lançamento se este campo estiver integrado com o sistema de arrecadação. \n \n A alteração desta data é possível a partir da Lista de Situações, na coluna Ações, por meio do botão Alterar Item.', 'Ajuda') ?>
                                       tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                        <img border="0"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" id="divHouveConstituicaoChk">
                                <div class="form-group">
                                    ...
                                    <a style="margin-left: 5px;; margin-top: 6px;"
                                    <?= PaginaSEI::montarTitleTooltip('A Constituição Definitiva do Crédito ficará disponível somente a partir do cadastro da Situação de Trânsito em Julgado (Conclusiva).', 'Ajuda') ?>
                                    tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                        <img border="0"
                                            src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg?<?= Icone::VERSAO ?>"
                                            class="infraImg imgAjudaCtrlProcLit"/>
                        ...
                        <div class="row nao-tem-constituicao">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <a style="margin-left: 5px;; margin-top: 6px;"
                                       <?= PaginaSEI::montarTitleTooltip('Neste campo deve ser selecionado o documento referente à Decisão Definitiva de Aplicação da Multa.', 'Ajuda') ?>
                                       tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                        <img border="0"
                                             src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                             class="infraImg imgAjudaCtrlProcLit"/>
                        ...
                        <div class="row tem-constituicao" id="divtxtDtConstituicao" style="display: none">
                            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                                <div class="form-group">
                                    ...
                                    <a style="margin-left: 5px;; margin-top: 6px;"
                                       <?= PaginaSEI::montarTitleTooltip('Deve informar a data correspondente à Constituição Definitiva, que refere-se ao dia seguinte à finalização do prazo de 30 dias concedido para pagamento após a intimação da decisão definitiva. \n \n O sistema faz uma sugestão automática que deve ser conferida e ajustada se for o caso.', 'Ajuda') ?>
                                       tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                        <img border="0"
                                             src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg?<?= Icone::VERSAO ?>"
                                             class="infraImg imgAjudaCtrlProcLit"/>
...
<input type="hidden" name="hdnLancamentoFracionado" id="hdnLancamentoFracionado" value=""/>
<input type="hidden" name="hdnRetificacaoDupla" id="hdnRetificacaoDupla" value=""/>
<input type="hidden" name="hdnLancamentoAlteradoDecisao" id="hdnLancamentoAlteradoDecisao" value=""/>
<input type="hidden" name="hdnIdLancamentoInicial" id="hdnIdLancamentoInicial" value=""/>
