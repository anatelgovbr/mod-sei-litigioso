...
class MdLitCamposAdINT extends InfraINT
{
            ...
            foreach($params['campos'] as $campo => $valor){
                ...
                switch ($objMdLitCamposAdDTO->getStrCampoTipo()) {
                    case MdLitCamposAdINT::$DATA:
                        $msg  .= self::validarCampoTipoData($objMdLitCamposAdDTO, $valor, $params['id_procedimento']);
                        break;
    ...
    private static function validarCampoTipoData($objMdLitCamposAdDTO, $valor, $idProcedimento)
    {
        $msg = '';

        if(self::validarCampoTipoDataExistente($objMdLitCamposAdDTO, $valor, $idProcedimento)){
            return $msg;
        } 
        ...
        if ($objMdLitCamposAdDTO->getStrValorMinimo() != null && $objMdLitCamposAdDTO->getStrValorMaximo() != null) {
            ...
            if ($objMdLitCamposAdDTO->getStrValorMinimo() == '@HOJE@' && $objMdLitCamposAdDTO->getStrValorMaximo() == '@FUTURO@') {
                ...
                if (InfraData::compararDatas($valor, InfraData::getStrDataAtual()) > 0) {
                    $msg .= "A data ".$valor. " para o campo " . $objMdLitCamposAdDTO->getStrNome() . " não é válida. O valor deve ser igual ou superior a " . InfraData::getStrDataAtual() . ".\n";
                }

            } else if ($objMdLitCamposAdDTO->getStrValorMinimo() == '@PASSADO@' && $objMdLitCamposAdDTO->getStrValorMaximo() == '@HOJE@') {

                if (InfraData::compararDatas($valor, InfraData::getStrDataAtual()) < 0) {
                    $msg .= "A data ".$valor. " para o campo " . $objMdLitCamposAdDTO->getStrNome() . " não é válida. O valor deve ser igual ou inferior a " . InfraData::getStrDataAtual() . ".\n";
                }
                ...
                if (InfraData::compararDatas($valor, InfraData::calcularData(1, InfraData::$UNIDADE_DIAS, InfraData::$SENTIDO_ADIANTE)) > 0) {
                    $msg .= "A data ".$valor. " para o campo " . $objMdLitCamposAdDTO->getStrNome() . " não é válida. O valor deve ser superior a " . InfraData::getStrDataAtual() . ".\n";
                }
                ...
                if (InfraData::compararDatas($valor, InfraData::calcularData(1, InfraData::$UNIDADE_DIAS, InfraData::$SENTIDO_ATRAS)) < 0) {
                    $msg .= "A data ".$valor. " para o campo " . $objMdLitCamposAdDTO->getStrNome() . " não é válida. O valor deve ser inferior a " . InfraData::getStrDataAtual() . ".\n";
                }
                ...
                if (InfraData::compararDatas($valor, $objMdLitCamposAdDTO->getStrValorMinimo()) > 0 ||
                  InfraData::compararDatas($valor, $objMdLitCamposAdDTO->getStrValorMaximo()) < 0
                    ...
                    $msg .= "A data ".$valor. " para o campo " . $objMdLitCamposAdDTO->getStrNome() . " não é válida. O valor deve estar entre " . $objMdLitCamposAdDTO->getStrValorMinimo() . " e " . $objMdLitCamposAdDTO->getStrValorMaximo() . ".\n";
                }
            }
        }
    ...
    private static function validarCampoTipoDataExistente($objMdLitCamposAdDTO, $valor, $idProcedimento)
    {
        $objMdLitCamposAdFormDTO = new MdLitCamposAdFormDTO();
        $objMdLitCamposAdFormDTO->setNumIdMdLitCamposAd($objMdLitCamposAdDTO->getNumIdMdLitCamposAd());
        $objMdLitCamposAdFormDTO->setDblIdProcedimento($idProcedimento);
        $objMdLitCamposAdFormDTO->setStrValor($valor);
        $objMdLitCamposAdFormDTO->retNumIdMdLitCamposAdForm();
        $objMdLitCamposAdFormDTO = (new MdLitCamposAdFormRN)->consultar($objMdLitCamposAdFormDTO);


        return $objMdLitCamposAdFormDTO ? true : false;
    }
