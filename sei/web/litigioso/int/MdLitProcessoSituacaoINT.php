...
class MdLitProcessoSituacaoINT extends InfraINT {
  ...
  public static function montarSelectDocumento($idProcedimento)
  {
    ...
    public static function calcularDataDecursoPrazoRecurso($idProcedimento, $strDtBase, $idProcessoSituacao)
    {
        $xml = '<resultado></resultado>';
        $dados = self::montarComboBoxDataDecursoPrazoRecurso($idProcedimento, $strDtBase, $idProcessoSituacao);
    ...
    public static function montarComboBoxDataDecursoPrazoRecurso($idProcedimento, $strDtBase, $idProcessoSituacao)
    {
        $htmlOption = '';
        ...
        $objUltimaSituacaoProcedimentoDTO->setStrSinDecisoriaSit('S');
        if($idProcessoSituacao)
          $objUltimaSituacaoProcedimentoDTO->setNumIdMdLitProcessoSituacao($idProcessoSituacao , InfraDTO::$OPER_MENOR);
