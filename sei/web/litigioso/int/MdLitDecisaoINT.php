...
//              continue;
            ...
            $infracaoArr[$index][] = isset($decisao['id_lancamento']) && $decisao['id_lancamento'] !== '' ? $decisao['id_lancamento'] : 'null';
            $infracaoArr[$index][] = isset($decisao['id_decisao_origem']) ? $decisao['id_decisao_origem'] : '';
            $index++;
        }
