...
try {
    ...
    if ($numRegistros > 0) {
        ...
        for ($i = 0; $i < $numRegistros; $i++) {
            ...
            $strResultado .= '<td class="mdLitTipoControleTexto">' . PaginaSEI::tratarHTML($arrObjTipoControleLitigiosoDTO[$i]->getStrSigla()) . '</td>';
            $strResultado .= '<td class="mdLitTipoControleTexto">' . PaginaSEI::tratarHTML($arrObjTipoControleLitigiosoDTO[$i]->getStrDescricao()) . '</td>';
