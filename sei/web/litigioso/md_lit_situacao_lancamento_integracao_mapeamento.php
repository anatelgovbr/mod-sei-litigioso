...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
    <div id="divCarregandoMapeamento" class="ajax-loading" style="position: absolute; width: 97%; background: #F8F8F8; padding: 7px 10px 4px; text-align: center; display: block; margin-top: 150px;">
...
?>
    <div id="divConteudoMapeamento" style="display: none;">
    ...
    <script type="text/javascript">
        document.getElementById('divCarregandoMapeamento').style.display = 'none';
        document.getElementById('divConteudoMapeamento').style.display = 'block';
    </script>
</div>
