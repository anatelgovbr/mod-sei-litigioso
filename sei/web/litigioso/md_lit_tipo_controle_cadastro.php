...
processos com Data de Autuação anterior à Data de Corte.', 'Ajuda') ?>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4">
                <div class="form-group">
                    <label id="lblPrazoDiasSugVenc" for="txtPrazoDiasSugVenc" class="infraLabelObrigatorio">Prazo em Dias de Sugestão de Data de Vencimento:
                        <a id="btAjudaPrazoDiasSugVenc" <?= PaginaSEI::montarTitleTooltip('Calcula nos processos o prazo em dias para sugerir a "Data de Vencimento" baseado no valor do campo "Data da Decisão de Aplicação da Multa".', 'Ajuda') ?>
                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                            <img border="0"
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg?<?= Icone::VERSAO ?>"
                                class="infraImgModulo"/>
                    ...
                    <input type="text" id="txtPrazoDiasSugVenc" name="txtPrazoDiasSugVenc" class="infraText form-control"
                        value="<?= PaginaSEI::tratarHTML($objTipoControleLitigiosoDTO->getNumPrazoDiasSugVenc()); ?>"
                        onkeypress="return infraMascara(this, event, '###')" maxlength="3" size="3" style="width: 5em;"
                        tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4">
                <div class="form-group">
                    <label id="lblPrazoDiasCritVencMin" for="txtPrazoDiasCritVencMin" class="infraLabelObrigatorio">Prazo em Dias para Crítica de Data de Vencimento Mínima:
                        <a id="btAjudaPrazoDiasCritVencMin" <?= PaginaSEI::montarTitleTooltip('Prazo em dias para crítica da "Data de Vencimento" mínima baseado no valor do campo "Data da Intimação da Decisão de Aplicação da Multa". Se configurado "0" (zero) vai criticar apenas para não poder ser data anterior à "Data da Intimação da Decisão de Aplicação da Multa".', 'Ajuda') ?>
                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                            <img border="0"
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg?<?= Icone::VERSAO ?>"
                                class="infraImgModulo"/>
                    ...
                    <input type="text" id="txtPrazoDiasCritVencMin" name="txtPrazoDiasCritVencMin" class="infraText form-control"
                        value="<?= PaginaSEI::tratarHTML($objTipoControleLitigiosoDTO->getNumPrazoDiasCritVencMin()); ?>"
                        onkeypress="return infraMascara(this, event, '###')" maxlength="3" size="3" style="width: 5em;"
                        tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"/>
                </div>
            </div>
