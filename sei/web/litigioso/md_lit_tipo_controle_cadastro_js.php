<script type="text/javascript">
    ...
    function validarCadastro() {
        ...
        if (infraTrim(document.getElementById('txtPrazoDiasSugVenc').value) == '') {
            alert('Informe o Prazo em Dias de Sugestão de Data de Vencimento.');
            document.getElementById('txtPrazoDiasSugVenc').focus();
            return false;
        }

        if (infraTrim(document.getElementById('txtPrazoDiasCritVencMin').value) == '') {
            alert('Informe o Prazo em Dias para Crítica de Data de Vencimento Mínima.');
            document.getElementById('txtPrazoDiasCritVencMin').focus();
            return false;
        }
        //alert('teste');
