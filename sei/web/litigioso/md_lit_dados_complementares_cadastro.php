...
//    InfraDebug::getInstance()->limpar();
    ...
    $strCnpjContato = $objContatoDTO->getStrCnpj();
    $contatoCpfCnpj = $objContatoDTO->getDblCpf() ? str_pad($objContatoDTO->getDblCpf(), 11, '0', STR_PAD_LEFT) : (ctype_digit($strCnpjContato) ? str_pad($strCnpjContato, 14, '0', STR_PAD_LEFT) : strtoupper($strCnpjContato));
    ...
    <?php foreach ($arrObjMdLitParametrizarInteressadoDTO as $objMdLitParametrizarInteressadoDTO) { ?>
        ...
        <?php if ($objMdLitParametrizarInteressadoDTO->getNumIdMdLitNomeFuncional() == MdLitNomeFuncionalRN::$OUTORGA) { ?>
            ...
            <? if ($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda() != '') { ?>
                <a <?= PaginaSEI::montarTitleTooltip($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda(), 'Ajuda') ?>
    ...
    <div id="outorgada">
        ...
        <div>
            <div class="rowFieldSet">
                <fieldset class="form-control fldInfoComplementares">
                    <legend class="infraLegend" class="infraLabelObrigatorio"> Informações
                        Complementares
                    </legend>
                    <div class="row linha">
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                            <button type="button" onclick="consultarNumero()" accesskey="A"
                                    name="sbmConsultarNumero" class="infraButton sbmConsultarNumero" value="Consultar"
                                    tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                Consultar
                            </button>
                        </div>
                        ...
                        <div class="rowFieldSet">
                            <fieldset class="form-control fldInfoComplementares">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                        <button type="button" onclick="consultarNumero()"
                                                accesskey="A" name="sbmConsultarNumero" class="infraButton sbmConsultarNumero"
                                                value="Consultar"
                                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                            Consultar
                                        </button>
                                ...
                                <div class="linha">
                                    <div class="rowFieldSet">
                                        <fieldset class="form-control fldInfoComplementares">
                                            ...
                                            <div class="linha">
                                                <div class="rowFieldSet">
                                                    <div class="fldInfoComplementares">
                                                        <legend class="infraLegend" class="infraLabelObrigatorio"> Informações Complementares
                                                        </legend>
                                                        <button type="button"
                                                                onclick="consultarNumero()" accesskey="A"
                                                                name="sbmConsultarNumero" class="infraButton sbmConsultarNumero"
                                                                value="Consultar"
                                                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                                            Consultar
                                                        </button>
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <legend id="lgdModalidadesOutorga"
                                                                        ...
                                                                        <? if ($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda() != '') { ?>
                                                                            <img src="<?= PaginaSEI::getInstance()->getDiretorioImagensGlobal() ?>/ajuda.gif"
                                                                                 name="ajuda"
                                                                                 <?= PaginaSEI::montarTitleTooltip($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda(), 'Ajuda') ?>
                                                                                 class="infraImg"/>
                                                                        <? } ?>
                                                                    </legend>
                                                            ...
                                                            <div>
                                                                <div class="rowFieldSet">
                                                                    <div
                                                                         class="form-control fldInfoComplementares">
                                                                        <legend class="infraLegend"
                                                                                class="infraLabelObrigatorio"> Informações
                                                                            Complementares
                                                                        </legend>
                                                                        <button type="button"
                                                                                onclick="consultarNumero()"
                                                                                accesskey="A" name="sbmConsultarNumero"
                                                                                class="infraButton sbmConsultarNumero" value="Consultar"
                                                                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                                                            Consultar
                                                                        </button>
                                                                        <? } ?>
                                        ...
                                        <? foreach ($arrObjMdLitParametrizarInteressadoDTO as $objMdLitParametrizarInteressadoDTO) { ?>
                                            <?php if ($objMdLitParametrizarInteressadoDTO->getNumIdMdLitNomeFuncional() == MdLitNomeFuncionalRN::$NUMERO
                                                ...
                                                <div class="infraAreaDados divNumero">
                                            ...
                                            <?php if ($objMdLitParametrizarInteressadoDTO->getNumIdMdLitNomeFuncional() == MdLitNomeFuncionalRN::$SERVICO
                                                ...
                                                <div class="infraAreaDados divServicos">
                                                    <label id="<?= 'lblServicos' ?>" for="txtServicos" accesskey="I"
                                                           class="<? echo $objMdLitParametrizarInteressadoDTO->getStrSinObrigatorio() == 'S' ? 'infraLabelObrigatorio' : 'infraLabelOpcional' ?>"><?= $objMdLitParametrizarInteressadoDTO->getStrLabelCampo() ?>:</label>
                                                    <input type="text" id="<?= 'txtServicos' ?>" name="txtServicos"
                                                           class="infraText"
                                                        ...
                                                        <legend id="<?= 'lgdModalidadesOutorga' ?>"
                                                            ...
                                                            &nbsp;<? if ($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda() != '') { ?>
                                                                <img
                                                                        ...
                                                                        name="ajuda"
                                                                        <?= PaginaSEI::montarTitleTooltip($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda(), 'Ajuda') ?>
                                                                        class="infraImg imgAjudaModalidade"/> <? } ?></legend>
                                                        <?php echo MdLitModalidadeINT::montarCheckboxModalidade($objMdLitParametrizarInteressadoDTO->getStrSinObrigatorio(), array(), 'onchange="desabilitarTxtNumero(document.getElementById(\'fldModalidadesOutorga\'))"') ?>
                                                    </fieldset>
                                                </div>
                                    ...
                                    <fieldset class="form-control fldInfoComplementares">
                                        ...
                                        <? foreach ($arrObjMdLitParametrizarInteressadoDTO as $objMdLitParametrizarInteressadoDTO) { ?>
                                            <?php if ($objMdLitParametrizarInteressadoDTO->getNumIdMdLitNomeFuncional() == MdLitNomeFuncionalRN::$CNPJ_CPF
                                                ...
                                                <label><?= $objMdLitParametrizarInteressadoDTO->getStrLabelCampo() ?>: <?= $objContatoDTO->getStrNome() . " - " . InfraUtil::formatarCpfCnpj($contatoCpfCnpj) ?></label>
                                                <? if ($objMdLitParametrizarInteressadoDTO->getStrDescricaoAjuda() != '') { ?>
                                                    <img align="top" src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg?<?= Icone::VERSAO ?>" class="infraImg"
